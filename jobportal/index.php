...
<html lang="en">
	<head>
		...
		<meta http-equiv="Refresh" content="5; url=<?= $_SERVER['HTTP_HOST'] ?>">
	</head>
	<style>	
* {
	    margin: 0;
	...
	<body>
	    ...
	    <div class="page-wrapper">
			<img src="img/Fav.png" alt="MYPA Logo" height="300px" width="auto">
	        ...
	        <div class="oops-message" >
	            <div class="test"><h3><b>Directory access is forbidden...</b></h3></div>
	        </div>
	    </div>
